...
const Linkedin = (props) => {
  return (
    <div>
      <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 400 97.6">
        <path
          class="logo1"
        ...
        <path
          class="logo1"
          d="M381.7,88.2c-0.4-0.1-1-0.1-1-0.3c-0.1-0.6,0-1.3,0-1.9v-0.1c0.7,0,1.4-0.2,2.1-0.1c0.3,0,0.7,0.5,0.8,0.8
                          c0.3,0.6-0.2,1.3-0.9,1.4c-0.3,0-0.6,0-0.9,0C381.7,88.1,381.7,88.1,381.7,88.2z"
        />
        <circle class="logo1" cx="381.8" cy="88.3" r="5.7" />
        <text transform="matrix(1 0 0 1 379.057 91.2305)" class="logo2 logo2font logo2font">
          R
        </text>
      </svg>
    </div>
